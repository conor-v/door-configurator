...
export const Door26 = (props) => {
	const { nodes, materials } = useGLTF("/doormodels/door26.glb");
	...
	return (
		<a.group {...props} dispose={null} position={[4.7, 0, 0.5]} rotation-y={rotation}>
			...
			<group rotation={[Math.PI / 2, 0, 0]} position={[0.45, 0, -0.3]} scale={[1.03, 1.05, 1.067]}>
				<mesh castShadow receiveShadow geometry={nodes.Set_D_Pattern_02039.geometry}>
					<meshStandardMaterial color={props.handleDeurColor()} />
				</mesh>
				<mesh
					castShadow
					receiveShadow
					geometry={nodes.Set_D_Pattern_02039_1.geometry}
					material={materials["Mate_White.001"]}
				/>
				<mesh
					castShadow
					receiveShadow
					geometry={nodes.Set_D_Pattern_02039_2.geometry}
					material={materials["Mate_Silver.001"]}
				/>
				<mesh
					castShadow
					receiveShadow
					geometry={nodes.Set_D_Pattern_02039_3.geometry}
...
useGLTF.preload("/doormodels/door26.glb");
