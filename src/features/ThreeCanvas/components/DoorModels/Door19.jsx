...
export const Door19 = (props) => {
	const { nodes, materials } = useGLTF("/doormodels/door19.glb");
	...
	return (
		<a.group {...props} dispose={null} position={[4.7, 0, 0.5]} rotation-y={rotation}>
			...
			<group rotation={[Math.PI / 2, 0, 0]} position={[0.45, 0, -0.3]} scale={[1.03, 1.05, 1.067]}>
				<mesh castShadow receiveShadow geometry={nodes.Set_D_Pattern_02024.geometry}>
					<meshStandardMaterial color={props.handleDeurColor()} />
				</mesh>
				<mesh
					castShadow
					receiveShadow
					geometry={nodes.Set_D_Pattern_02024_1.geometry}
					material={materials["Mate_White.007"]}
				/>
				<mesh
					castShadow
					receiveShadow
					geometry={nodes.Set_D_Pattern_02024_2.geometry}
					material={materials["Mate_Silver.007"]}
				/>
				<mesh
					castShadow
					receiveShadow
					geometry={nodes.Set_D_Pattern_02024_3.geometry}
...
useGLTF.preload("/doormodels/door19.glb");
