...
export const Door7 = (props) => {
	const { nodes, materials } = useGLTF("/doormodels/door7.glb");
	...
	return (
		<a.group {...props} dispose={null} position={[6, 0, 0.2]} rotation-y={rotation}>
			...
			<mesh
				castShadow
				receiveShadow
				geometry={nodes.DBLIJN4HZ_door.geometry}
				material={materials["Material.036"]}
				position={[-0.6 - 5.9, 0, -0.2]}
				rotation={[0, 0, 0]}
				scale={0.306}
				scale-x={0.36}
			/>
...
useGLTF.preload("/doormodels/door7.glb");
