...
export const Door28 = (props) => {
	const { nodes, materials } = useGLTF("/doormodels/door28.glb");
	...
	return (
		<a.group {...props} dispose={null} position={[6, 0, 0.2]} rotation-y={rotation}>
			...
			<group rotation={[Math.PI / 2, 0, 0]} position={[7 - 5.9, 0, 0.2]} scale={1.134} scale-x={1.369}>
				<mesh
					castShadow
					receiveShadow
				...
				<mesh
					castShadow
					receiveShadow
					geometry={nodes.Set_D_Pattern_02041_1.geometry}
					material={materials["Mate_White.007"]}
				/>
				<mesh
					castShadow
					receiveShadow
					geometry={nodes.Set_D_Pattern_02041_2.geometry}
					material={materials["Mate_Silver.007"]}
				/>
				<mesh
					castShadow
					receiveShadow
					geometry={nodes.Set_D_Pattern_02041_3.geometry}
...
useGLTF.preload("/doormodels/door28.glb");
