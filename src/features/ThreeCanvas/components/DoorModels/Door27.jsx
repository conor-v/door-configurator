...
export const Door27 = (props) => {
	const { nodes, materials } = useGLTF("/doormodels/door27.glb");
	...
	return (
		<a.group {...props} dispose={null} position={[6, 0, 0.2]} rotation-y={rotation}>
			...
			<group position={[-5 - 5.9, 0.5, 0.45 - 0.2]} rotation={[-Math.PI, 4.7, -Math.PI]} scale={12}>
			...
			<group rotation={[Math.PI / 2, 0, 0]} position={[7 - 5.9, 0, 0]} scale={1.134} scale-x={1.369}>
				<mesh
					castShadow
					receiveShadow
					geometry={nodes.Set_D_Pattern_02026.geometry}
					material={materials["Wood___Plastic_Frames.002"]}
				/>
				<mesh
					castShadow
					receiveShadow
					geometry={nodes.Set_D_Pattern_02026_1.geometry}
					material={materials["Mate_White.002"]}
				/>
				<mesh
					castShadow
					receiveShadow
					geometry={nodes.Set_D_Pattern_02026_2.geometry}
					material={materials["Mate_Silver.002"]}
				/>
				<mesh
					castShadow
					receiveShadow
					geometry={nodes.Set_D_Pattern_02026_3.geometry}
...
useGLTF.preload("/doormodels/door27.glb");
